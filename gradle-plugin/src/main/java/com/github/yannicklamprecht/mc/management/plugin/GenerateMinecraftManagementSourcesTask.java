    ...
    public void generate() throws IOException {
        if (!getPackageName().isPresent() || getPackageName().get().trim().isEmpty()) {
            throw new InvalidUserDataException(
                    "The 'packageName' property in 'minecraftManagement' extension must be configured (e.g. packageName.set(\"com.github.yannicklamprecht.mc.management.generated\"))."
            );
        }
        ...
        String clientClass = getClientClassName().getOrElse("com.github.yannicklamprecht.mc.management.transport.MinecraftManagementClient");
