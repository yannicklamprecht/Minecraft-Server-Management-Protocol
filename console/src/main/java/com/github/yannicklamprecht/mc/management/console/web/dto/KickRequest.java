 ...
 *                           kick; ignored (server-side mode wins) unless
 ...
 */
public record KickRequest(String playerNameOrUuid, String reason, Boolean notifyOperators, String playerDisplayName) {
}
